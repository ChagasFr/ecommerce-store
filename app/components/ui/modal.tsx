                ...
                <div className="fixed insert-0 overflow-auto">
                    <div className="flex mih-h-full items-center justify-center p-4 text-center">
                        ...
                        <Transition.Child
                            ...
                            enterTo="opacity-100 scalte-100"
                            leave="ease-in duration-200"
                            leaveFrom="opacity-100 scalte-100"
                            leaveTo="opacity-0 scalte-95"
                        >
                            <Dialog.Panel className="w-full max-w-3xl overflow-hidden rounded-lg text-left align-middle">
                                <div className="relative flex w-full items-center overflow-hidden bg-white px-4 pb-8pt-14 shadow-2xl sm:px-6 ms:pt-8 md:p-6 lg:p-8">
